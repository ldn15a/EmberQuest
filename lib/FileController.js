var FileController = function () {
    ...
    fr.requestFile = function (filePath, funct) {
        //  Create request
    ...
    fr.hasRequestedFile = function (filePath) {
        return (fr.private.filesMap.has (filePath) || fr.private.requestsMap.has (filePath));
    }
    ...
    fr.readLine = function (filePath, lineNumber) {
        if (fr.private.filesMap.has (filePath)) {
            return fr.private.filesMap.get (filePath) [lineNumber];
        }
