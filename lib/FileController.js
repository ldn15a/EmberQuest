var FileController = function () {
    ...
    fr.legacy.requestFile = function (filePath, funct) {
		console.warn ("You used a legacy FileController function. Please use PIXI loader instead of requesting files.");
		//  Create request
    ...
    fr.legacy.isFileReady = function (filePath) {
		console.warn ("You used a legacy FileController function. All files should finish loading before PIXI starts rendering or starts game loop, so all files are ready whenever you need them.");
    ...
    fr.legacy.read = function (filePath) {
		console.warn ("You used a legacy FileController function. Use function \"fileController.readFile\" instead.");
        if (fr.legacy.private.filesMap.has (filePath)) {
    ...
    fr.legacy.readLine = function (filePath, lineNumber) {
		console.warn ("You used a legacy FileController function. Use function \"fileController.readFileLine\" instead.");
        if (fr.legacy.private.filesMap.has (filePath)) {
