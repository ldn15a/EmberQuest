    	...
    	if(dialogueParser.ready){
	    	...
	    	if(dialogueParser.returnTo != null){
		    	...
		    	while(true){
		    		...
		    		var testString = dialogueParser.relaventDialogue[c].substring(0,1);
	    		...
	    		console.log("RETURNED TO LINE: "+dialogueParser.relaventDialogue[currentIndex]);
	    		textObject = TextObject(dialogueParser.relaventDialogue[currentIndex],dialogueParser.parseLine(dialogueParser.relaventDialogue[currentIndex],false));
	    		dialogueParser.returnTo = null;
	    	}else if(dialogueParser.goTo != null){
	    		var c = 0;
		    	while(true){
		    		if(c >= dialogueParser.relaventDialogue.length){
		    			break;
