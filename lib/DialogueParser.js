	...
	dialogueParser.parseSetup = function () {
		...
		while (c < dialogueParser.text.length) {
			...
			if (dialogueParser.text[c].substring(0, 3) === "if(") {
				...
				//console.log(dialogueParser.text[c].substring(3, dialogueParser.text[c].length - 3));
				if (dialogueParser.parseConditions(dialogueParser.text[c].substring(3, dialogueParser.text[c].length - 3))) {
				...
				if (dialogueParser.parseConditions(dialogueParser.text[c].substring(8, dialogueParser.text[c].length - 3))) {
					//console.log("this is the starting index.");
					dialogueParser.relaventStartingIndex = c;
					break;
				}
