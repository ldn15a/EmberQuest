var MapLoader = function () {
	...
	mapLoader.private.makeMarshMudWater = function (x, y) {
		mapLoader.private.currentAreaObjRef.private.grasses.push(Wall(x, y, marsh_mud_water_tile, false, 0.5));
	}

	mapLoader.private.makeMarshWaterMud = function (x, y) {
		mapLoader.private.currentAreaObjRef.private.grasses.push(Wall(x, y, marsh_water_mud_tile, false, 0.5));
	}

	mapLoader.private.makeMarshMudWaterMiddle = function (x, y) {
		mapLoader.private.currentAreaObjRef.private.grasses.push(Wall(x, y, marsh_mud_water_middle_tile, false, 1));
	}

	mapLoader.private.makeMarshWaterMudMiddle = function (x, y) {
		mapLoader.private.currentAreaObjRef.private.grasses.push(Wall(x, y, marsh_water_mud_middle_tile, false, 1));
	}

	mapLoader.private.makeMarshWater = function (x, y) {
		mapLoader.private.currentAreaObjRef.private.grasses.push(Wall(x, y, marsh_water_tile, false, 2.5));
    }
