var MapLoader = function () {
	...
	mapLoader.private.makeNaia = function (x, y) {
		...
		//mapLoader.private.currentAreaObjRef.NPCs.push(NPC((x * 64) + 32, (y * 64) + 32, redFlameStillAsset, "dialog/Naia1.txt"));
		console.warn ("You tried creating an NPC, which will be supported but currently is not. Stay tunes for updates soon.");
	}
