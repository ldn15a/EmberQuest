	...
	player.update = function(){
		...
		if(player.canControl){
			...
			if(keyboard.getKeyStatus("j") == "pressed" && player.fireCooldownTimer < player.fireRate - player.minimumFireRate){
				...
				generatedObjectsArray[generatedObjectsArray.length] = FireProjectile(player.character.graphic.x,player.character.graphic.y,player.attackDir,player,redFlameMovingAsset);
