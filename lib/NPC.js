function NPC(x, y, asset, textFile) {
    ...
    npc.NaiaZeldaWalk = function(){
        if(npc.character.getPositionX() < npc.character.calculatePositionX(npc.originX) + npc.generic_zeldaWalkRange && npc.character.getPositionX() > npc.character.calculatePositionX(npc.originX) - npc.generic_zeldaWalkRange){
