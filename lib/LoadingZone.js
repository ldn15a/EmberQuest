var loadingZone = function(x,y,isInteractable,area){
	...
	loadingZone.update = function(){
		if(playerArray[0] != undefined && playerArray[0].character != undefined){
			//are we in range?
			if(playerArray[0].character.getPositionX() >= playerArray[0].character.calculatePositionX(loadingZone.originX)-loadingZone.width && playerArray[0].character.getPositionX() <= playerArray[0].character.calculatePositionX(loadingZone.originX)+loadingZone.width){
