function NPCVariables () {
    ...
    npcVariables.initialize = function () {
        ...
        npcVariables.Naia_naiaFriendship=0;
        npcVariables.Naia_naiaEnd=0;
        npcVariables.Naia_elderQuestion=0;
        npcVariables.Naia_tideQuestion=0;
        npcVariables.Naia_childQuestion=0;
        npcVariables.Naia_numAsked=0;
        npcVariables.Naia_motiveReveal=0;
        npcVariables.Naia_askedFestival=0;
        npcVariables.Naia_thiefStory=0;
        npcVariables.Naia_naiaPlan=0;
        npcVariables.Naia_wraithSoothed=0;
        npcVariables.Naia_naiaSuspicious=0;
        npcVariables.Naia_wraithQuestion=0;
        npcVariables.Naia_naiaDistract=0;
        npcVariables.Absent_absentMindedEncounter=0;
        npcVariables.Worried_firstEncounterWorried=0;
        npcVariables.Worried_blackIceRumorKnown=0;
        npcVariables.MerchantAgent_askedWho=0;
        npcVariables.MerchantAgent_askedVillage=0;
        npcVariables.MerchantAgent_askedTrade=0;
        npcVariables.MerchantAgent_renzelJob=0;
    }();
