...
var marsh_background = Asset("marsh_background", "assets/images/The Marsh/background/marshbackground GV.png", 1, 1, 1, 1, 0.5, 0.2);
...
var tree_branch_base2 = Asset("tree_branch_base2", "assets/images/The Marsh/Trunk Stuff/Tree_branch_base2 GV.png", 1, 1, 1, 1, 0.63, 0.5);
...
var trunk_w = Asset("trunk_w-rings", "assets/images/The Marsh/Trunk Stuff/Trunk_w-rings GV.png", 1, 1, 0.5, 0.5, 0.5, 0.5);
...
var closed_gate = Asset("closed_gate", "assets/images/The Marsh/Closed Gate GV.png", 1, 1, 1, 1.1, 0.5, 0.5);
var doorway_general = Asset("doorway_general", "assets/images/The Marsh/doorwayGeneral GV.png", 1, 1, 1, 1, 0.5, 0.75);
...
var flame_statue = Asset("statue", "assets/images/The Marsh/flameStatue GV.png", 1, 1, 1, 1, 0.5, 0.5);
var prison_cell = Asset ("prisonCell", "assets/images/The Marsh/prisonCell GV.png", 1, 1, 1, 1, 0.5, 0.5);
...
var naia_flame_left = Asset("naia_flame", "assets/images/sprites/Naia/NaiaFlameLeft GV.png", 1, 1, 1, 1, 0.5, 0.5);
var naia_flame_right = Asset("naia_flame", "assets/images/sprites/Naia/NaiaFlameRight GV.png", 1, 1, 1, 1, 0.5, 0.5);
var npc_flame = Asset("npc_flame", "assets/images/sprites/NPC/NPCflame GV.png", 1, 1, 1, 1, 0.5, 0.5);
var npc_flame_left = Asset("npc_flame", "assets/images/sprites/NPC/NPCflameLeft GV.png", 1, 1, 1, 1, 0.5, 0.5);
var npc_flame_right = Asset("npc_flame", "assets/images/sprites/NPC/NPCflameRight GV.png", 1, 1, 1, 1, 0.5, 0.5);
var npc_flame_2 = Asset("npc_flame_2", "assets/images/sprites/NPC/NPCflame2 GV.png", 1, 1, 1, 1, 0.5, 0.5);
var npc_flame_2_left = Asset("npc_flame_2", "assets/images/sprites/NPC/NPCflame2Left GV.png", 1, 1, 1, 1, 0.5, 0.5);
var npc_flame_2_right = Asset("npc_flame_2", "assets/images/sprites/NPC/NPCflame2Right GV.png", 1, 1, 1, 1, 0.5, 0.5);
...
var true_trunk = Asset("true_trunk", "assets/images/The Marsh/TheOneTrueTrunk GV.png", 1, 1, 1.5, 1.5, 0.5, 0.5);
...
PIXI.Loader.shared.add ("opening Area", "assets/audio/soundtracks/openingArea.wav");
...
PIXI.Loader.shared.add ("NaiaFromPlatform", "dialogue/NaiaFromPlatform.txt");
PIXI.Loader.shared.add ("NaiaHeavyMarshPreMiniboss", "dialogue/NaiaHeavyMarshPreMiniboss.txt");
PIXI.Loader.shared.add ("NaiaHeavyMarshStart", "dialogue/NaiaHeavyMarshStart.txt");
PIXI.Loader.shared.add ("NaiaMarshPostMiniboss", "dialogue/NaiaMarshPostMiniboss.txt");
PIXI.Loader.shared.add ("NaiaShrine", "dialogue/NaiaShrine.txt");

PIXI.Loader.shared.add ("CheeryVillager", "dialogue/CheeryVillager.txt");
PIXI.Loader.shared.add ("AbsentMindedVillager", "dialogue/AbsentMindedVillager.txt");
PIXI.Loader.shared.add ("BitterVillager", "dialogue/BitterVillager.txt");
PIXI.Loader.shared.add ("HungryVillager", "dialogue/HungryVillager.txt");
PIXI.Loader.shared.add ("NostalgicVillager", "dialogue/NostalgicVillager.txt");
PIXI.Loader.shared.add ("OddVillager", "dialogue/OddVillager.txt");

PIXI.Loader.shared.add ("WorriedNortherner", "dialogue/WorriedNortherner.txt");
...
PIXI.Loader.shared.add ("Maps/deepMarsh.csv", "Maps/deepMarsh.csv");
PIXI.Loader.shared.add ("Maps/Grotto.csv", "Maps/Grotto.csv");
PIXI.Loader.shared.add ("Maps/village.csv", "Maps/village.csv");
PIXI.Loader.shared.add ("Maps/bossRoom.csv", "Maps/bossRoom.csv");
